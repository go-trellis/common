...
* [![GoDoc](http://godoc.org/github.com/go-trellis/common/storage/cache?status.svg)](http://godoc.org/github.com/go-trellis/common/storage/cache)
...
```shell
go get "github.com/go-trellis/common/storage/cache"
```
