...
* [![GoDoc](http://godoc.org/github.com/go-trellis/common.v2/cache?status.svg)](http://godoc.org/github.com/go-trellis/common.v2/cache)
...
```shell
go get "github.com/go-trellis/common.v2/cache"
```
