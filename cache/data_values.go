...
// ValueMode
const (
	// ValueModeUnique only one value
	ValueModeUnique ValueMode = iota
	// ValueModeBag The table is a bag table, which can have many objects
	// but only one instance of each object, per key.
	ValueModeBag
	// ValueModeDuplicateBag The table is a duplicate_bag table, which can have many objects,
